...
> 现代化个人文件管理与分类收纳平台 —— 重新定义文件管理方式，让每份文件都有它的归属。
...
**收纳盒 (Rainbow-box)** 是一个基于 Next.js 的现代化个人文件管理与分类收纳平台。它以七种颜色作为分类体系，让文件管理变得直观、优雅且高效。支持拖拽上传、在线预览、智能搜索、收藏、回收站等丰富的功能，并拥有精美的 Three.js 粒子动画首页和暗黑/明亮双主题切换。
...
| **3D 渲染** | [Three.js](https://threejs.org/) | ^0.170.0 | WebGL 3D 场景渲染 |
| **React 3D** | [@react-three/fiber](https://docs.pmnd.rs/react-three-fiber) | ^9.6.0 | React 渲染器 for Three.js |
...
| **Category** | 分类 | 七彩分类体系 | name+userId 唯一、sortOrder 索引 |
