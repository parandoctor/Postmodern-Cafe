...
function FeatureCard({ icon: Icon, title, description, gradient, delay }: FeatureCardProps) {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-6 backdrop-blur-sm transition-all duration-500 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1">
        ...
        <div className="absolute inset-0 rounded-2xl opacity-0 transition-opacity duration-500 group-hover:opacity-100"
          style={{
            background: "linear-gradient(135deg, transparent 40%, hsl(var(--primary) / 0.1), transparent 60%)",
...
const features = [
  ...
  },
  {
    icon: Palette,
    title: "七彩分类",
    description: "红橙黄绿青蓝紫七种固定配色，每种颜色对应一类文件，统一的视觉规范让管理更直观。",
  ...
  },
  {
    ...
    gradient: "bg-gradient-to-br from-yellow-500/5 via-transparent to-transparent",
  },
  {
    icon: Trash2,
    title: "回收站",
  ...
  },
  {
    ...
    gradient: "bg-gradient-to-br from-indigo-500/5 via-transparent to-transparent",
  },
  {
    icon: RefreshCw,
    title: "批量操作",
    description: "批量移动、删除、收藏、下载，选中多个文件一键完成批量管理操作。",
    gradient: "bg-gradient-to-br from-pink-500/5 via-transparent to-transparent",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            强大而优雅的
            <span className="rainbow-text">文件管理</span>
          </h2>
